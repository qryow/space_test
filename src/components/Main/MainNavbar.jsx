                ...
                <div className={style.nav__left}>
                    <div className={style.nav__search}>
                        ...
                        <div className={style.dropdown}>
                            <div
                                className={
                                    dropdownActive
                                        ? `${style.dropdown__info}`
                                        : `${style.dropdown__info} ${style.info__active}`
                                }
                                ref={menuRef}
                            >
                                <div
                                    className={style.dropdown__title__wrapper}
                                    onClick={() =>
                                        setDropdownActive(!dropdownActive)
                                    }
                                >
                                    <h4 className={style.dropdown__title}>
                                        {" "}
                                        {selectedCategory}{" "}
                                    </h4>
                                </div>
                            ...
                            >
                                ...
                                <div
                                    className={style.dropdown__item}
                                    id={style.dropdown__item_last}
                                    onClick={() =>
                                        handleCategoryClick("Podcast")
                                    }
                                >
                    ...
                    <div className={style.nav__profile} ref={detailRef}>
                        <div className={style.profile__wrapper}>
                            {isUserLogin() ? (
                                <>
                                    ...
                                    <div className={style.profile__btn}>
                                        <div
                                            className={
                                                isHovered
                                                    ? `${style.profile__btn_wrapper} ${style.btn__active}`
                                                    : `${style.profile__btn_wrapper}`
                                            }
                                            onClick={() =>
                                ...
                                <>
                                    ...
                                    >
                                        <div
                                            className={style.login__btn_wrapper}
                                        >
                                            <img
                                                className={style.login__icon}
                                                src={profileIcon}
                                                alt=""
                                            />
                                            <h4 className={style.login__title}>
                                                Login
                                            </h4>
                                        </div>
                                    </div>
                        ...
                        <div
                            className={
                                isHovered
                                    ? `${style.detail__menu} ${style.details__active}`
                                    : `${style.detail__menu}`
                            }
                            ref={detailRef}
                        >
                            <div className={style.detail__item}>
                                <img
                                    className={style.acc__img}
                                    src={detailAccount}
                                    alt=""
                                />
                                <h5 className={style.details__title}>
                                    My Account
                                </h5>
                            </div>
                            <div className={style.detail__item}>
